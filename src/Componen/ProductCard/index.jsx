...
const ProductCard = ({
  ...
  return (
    <div className="border p-4 rounded-lg shadow-md bg-white hover:shadow-lg transition-shadow duration-300">
      <Link
      ...
      <div className="flex space-x-2">
        ...
        <button
          ...
          className="bg-gray-300 text-black py-2 px-4 rounded-lg hover:bg-gray-400 transition-colors duration-300 flex items-center"
        >
          <FontAwesomeIcon
            icon={faHeart}
